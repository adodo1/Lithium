...
(function($){
	...
	$.extend($.ui.dialog.prototype, {
		...
		minimize: function() { 
			...
			$('#queryDialog').dialog( "option", "title", "Панель поиска");

			this.uiDialog.resizable( "option", "disabled", true );
			$(".ui-state-disabled").removeClass('ui-state-disabled').addClass('ui-min').addClass('ui-corner-all');
