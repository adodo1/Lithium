...
(function ($) {
    ...
    var showRegistrationForm = function (afterRegistration) {
        ...
        <form>\
            ...
            <tr><td colspan="2">\
            <div class="policy">\
            Нажимая на кнопку, вы соглашаетесь с <a target="blank" href="//my.kosmosnimki.ru/Docs/Политика конфиденциальности.pdf">политикой конфиденциальности</a><br>\
            и <a target="blank" href="//my.kosmosnimki.ru/Docs/Политика оператора в отношении обработки и защиты персональных данных.pdf">политикой оператора</a> в отношении обработки и защиты<br> персональных данных\
            </td></tr>\
            </table>\
        </form>\
        </td></tr></table>'
